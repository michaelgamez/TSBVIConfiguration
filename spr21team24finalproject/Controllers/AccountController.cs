    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel rvm)
        {
            ...
            { 
                ...
                String toemail = rvm.Email;
                String emailsubject = "Welcome! Account Created!";
                String messagebody = "Your Account has been created!";
        ...
        // GET: /Account/CustomerEditAccountInfo
        public ActionResult CustomerEditAccount()
        {
            return View();
        }


        // POST: /Account/CustomerEditAccountInfo
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> CustomerEditAcccount(CustomerEditViewModel cevc)
        {
            //if user forgot a field, send them back to 
            //edit account page to try again
            if (ModelState.IsValid == false)
            {
                return View(cevc);
            }
            ...
            userLoggedIn.FirstName = cevc.FirstName;
            userLoggedIn.LastName = cevc.LastName;
            userLoggedIn.Email = cevc.Email;
            userLoggedIn.PhoneNumber = cevc.PhoneNumber;
            userLoggedIn.Address = cevc.Address;
            userLoggedIn.ZipCode = cevc.ZipCode;

            await _context.SaveChangesAsync();


            //send the user back to the acount info page to try again
            return RedirectToAction("Index", "Account");
           
        }


        // GET: /Account/EmployeeEditAccountInfo
        public ActionResult EmployeeEditAccount()
        {
            return View();
        }


        // POST: /Account/EmployeerEditAccountInfo
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> EmployeeEditAccount(EmployeeEditViewModel eevc)
        {
            //if user forgot a field, send them back to 
            //edit account page to try again
            if (ModelState.IsValid == false)
            ...
            userLoggedIn.PhoneNumber = eevc.PhoneNumber;
            userLoggedIn.Address = eevc.Address;
            userLoggedIn.ZipCode = eevc.ZipCode;
