...
namespace spr21team24finalproject.Controllers
{
    public class SeedController : Controller
    {
        ...
        public async Task<IActionResult> SeedRoles()
        {
            try
            {
                await Seeding.SeedRoles.SeedAllRoles(_roleManager);
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> SeedSongs()
        {
            try
            {
                Seeding.SeedSongs.SeedAllSongs(_context);
            }
            catch (Exception ex)
            {
                //add the error messages to a list of strings
        ...
        public async Task<IActionResult> SeedArtists()
        {
            try
            {
                Seeding.SeedArtists.SeedAllArtists(_context);
            }
            catch (Exception ex)
            {
                //add the error messages to a list of strings
        ...
        public async Task<IActionResult> SeedAlbums()
        {
            try
            {
                Seeding.SeedAlbums.SeedAllAlbums(_context);
            }
            catch (Exception ex)
            {
                //add the error messages to a list of strings
        ...
        public async Task<IActionResult> SeedArtistReviews()
        {
            try
            {
                Seeding.SeedArtistReviews.SeedAllArtistReviews(_context);
            }
            catch (Exception ex)
            {
                //add the error messages to a list of strings
        ...
        public async Task<IActionResult> SeedAlbumReviews()
        {
            try
            {
                Seeding.SeedAlbumReviews.SeedAllAlbumReviews(_context);
            }
            catch (Exception ex)
            {
                //add the error messages to a list of strings
        ...
        public async Task<IActionResult> SeedSongReviews()
        {
            try
            {
                Seeding.SeedSongReviews.SeedAllSongReviews(_context);
            }
            catch (Exception ex)
            {
                //add the error messages to a list of strings
